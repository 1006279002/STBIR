...
# number of effective samples for reporting
...
# optimizer with safe fallback for learning rate
# Coerce learning rate to float with fallbacks
...
# safe fallback for epochs in scheduler
...
with torch.no_grad():
    ...
    for batch in test_pbar:
        ...
        images, texts = val_data.get_samples()
        images = images.to(device)
        texts = texts.to(device)
